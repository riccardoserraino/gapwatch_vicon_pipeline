...
for i in range(len(pos_hand)):
    ...
    angles = [
        calculate_finger_angle(f1_rel, hand_points['h3'], [0.1, 0, 0]),  # Finger 1
        calculate_finger_angle(f5_rel, hand_points['h4'], [0.01, 0, 0]), # Finger 2
        calculate_finger_angle(f4_rel, hand_points['h5'], [0.01, 0, 0]), # Finger 3
        calculate_finger_angle(f2_rel, hand_points['h6'], [0.01, 0, 0]), # Finger 4
        calculate_finger_angle(f3_rel, hand_points['h1'], [0.01, 0.01, 0]) # Finger 5
    ]
