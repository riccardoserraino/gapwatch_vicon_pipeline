...
fig_bp, (ax_mag_bp, ax_phase_bp) = plt.subplots(2, 1, figsize=(7, 5), sharex=True)
...
fig_notch, (ax_mag_notch, ax_phase_notch) = plt.subplots(2, 1, figsize=(7, 5), sharex=True)
...
fig_combined, (ax_mag_combined, ax_phase_combined) = plt.subplots(2, 1, figsize=(7, 5), sharex=True)
...
fig_combined_filtfilt, (ax_mag_combined_filtfilt, ax_phase_combined_filtfilt) = plt.subplots(2, 1, figsize=(7, 5), sharex=True)
...
ax_mag_filtfilt.set_title(f'Magnitude - Bandpass + Notch (with Zero Phase Filtering)')
ax_mag_filtfilt.set_ylabel('Gain (dB)', fontsize=12)
...
ax_phase_filtfilt.set_title(f'Phase - Bandpass + Notch (with Zero Phase Filtering)')
ax_phase_filtfilt.set_xlabel('Frequency (Hz)', fontsize=12)
ax_phase_filtfilt.set_ylabel('Phase (degrees)', fontsize=12)
